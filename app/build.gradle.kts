plugins {
    ...
    alias(libs.plugins.google.gms.google.services) // Keep Google Services plugin here for Firebase
}
...
dependencies {
    ...
    // Security and Crypto Libraries (for secure data storage)
